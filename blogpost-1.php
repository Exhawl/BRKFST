    ...
    <div class="full-wrapper relative clearfix">
        ...
        <div class="inner-nav desktop-nav">
            ...
            <!-- End Items -->
               ...
               <li class="phone-fix">
                    <a href="sv/blogpost-1.php" class="active">Svenska</a>
               ...
               <li class="phone-fix-1">
                ...
                <ul class="mn-sub">
                    ...
                    <li><a href="sv/blogpost-1.php">Svenska</a></li>
            ...
            <section class="small-section bg-gray-lighter">
                <div class="relative container align-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Blogpost</h1>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="blog-item mb-80 mb-xs-40">
    							...
    							<div class="blog-item-body">
                                    ...
                                    <h1 class="mt-0 font-alt">GOOGLE'S LATEST DESIGN UPPDATE</h1>
                            ...
                            <div class="clearfix mt-40">
                                ...
                                <a href="blogpost-2.php" class="blog-item-more right">Next post&nbsp;<i class="fa fa-angle-right"></i></a>
                            </div>
                            <!-- End Prev/Next Post -->
