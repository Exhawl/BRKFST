        ...
        <div class="inner-nav desktop-nav">
            <ul class="clearlist">
             ...
             <!-- End Items -->
               ...
               <li class="phone-fix">
                    <a href="sv/our-work.php" class="active">Svenska</a>
               ...
               <li class="phone-fix-1">
                ...
                <ul class="mn-sub">
                    ...
                    <li><a href="sv/our-work.php">Svenska</a></li>
...
=======
             <?php include('nav.html'); ?>
>>>>>>> e9e776230c872c3f4b511233a5918bd0deff8e9a:our-work.php
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a href="index.php">Home</a>&nbsp;/&nbsp;<span>Work</span>
                        </div>
        ...
        <!-- End Section -->
            ...
            <section class="page-section pb-0 background-dark padding-top-portfolio">
                <div class="relative">
                    ...
                    <!-- Works Grid -->
                    <ul class="works-grid work-grid-2 clearfix font-alt hover-white hide-titles" id="work-grid">
                        ...
                        <img href="images/portfolio/sthlm-2.png" class="work-lightbox-link mfp-image"></img>
                        <img href="images/portfolio/sthlm-3.png" class="work-lightbox-link mfp-image"></img>
                        <!-- End Work Item -->
                        ...
                        <img href="images/portfolio/laptop-loelle.png" class="lightbox-gallery-1 mfp-image"></img>
                        <img href="images/portfolio/loelle-3.png" class="lightbox-gallery-1 mfp-image"></img>
                        <!-- End Work Item -->
                        
                        <!-- Work Item (External Page) -->
                        <li class="work-item mix branding">
                            <a href="images/portfolio/cbs-1.png" class="lightbox-gallery-2 mfp-image">
                                <div class="work-img">
                                    <img class="work-img" src="images/portfolio/projects-cbs.jpg" alt="Work" />
                                </div>
                                <div class="work-intro">
                        ...
                        <img href="images/portfolio/laptop-cbs.png" class="lightbox-gallery-2 mfp-image"></img>
                        <!-- End Work Item -->
                        
                        <!-- Work Item (External Page) -->
                        <li class="work-item mix design photography">
                            <a href="images/portfolio/laptop-ettsmart.png" class="lightbox-gallery-3 mfp-image">
                                <div class="work-img">
                                    <img class="work-img" src="images/portfolio/projects-ettsmart.jpg" alt="Work" />
                                </div>
                                <div class="work-intro">
                        ...
                        <img href="images/portfolio/ettsmart-2.png" class="lightbox-gallery-3 mfp-image"></img>
                        <!-- End Work Item -->
