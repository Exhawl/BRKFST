...
<html>
    <head>
        <title>Breakfast Boys - Contact</title>
    ...
    <div class="full-wrapper relative clearfix">
        ...
        <div class="inner-nav desktop-nav">
            ...
            <!-- End Items -->
               ...
               <li class="phone-fix">
                    <a href="sv/contact.php" class="active">Svenska</a>
               ...
               <li class="phone-fix-1">
                ...
                <ul class="mn-sub">
                    ...
                    <li><a href="sv/contact.php">Svenska</a></li>
...
=======
            <?php include('nav.html'); ?>
>>>>>>> e9e776230c872c3f4b511233a5918bd0deff8e9a:contact.php
