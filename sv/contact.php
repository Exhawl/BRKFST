...
<html>
    <head>
        <title>Breakfast Boys - Kontakt</title>
    ...
    <div class="full-wrapper relative clearfix">
        ...
        <div class="inner-nav desktop-nav">
            ...
            <?php include('nav.html'); ?>
                ...
                <li class="phone-fix">
                    <a href="../contact.php" class="active">English </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="hs-line-4 font-alt">
                            Har du ett intressant projekt eller bara en riktigt bra ide?
                    ...
                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a href="index.php">Startsida</a>&nbsp;/&nbsp;<span>Kontakt</span>
                        </div>
