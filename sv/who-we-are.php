    ...
    <div class="full-wrapper relative clearfix">
        ...
        <div class="inner-nav desktop-nav">
            ...
            <?php include('nav.html'); ?>
                ...
                <li class="phone-fix">
                    <a href="../who-we-are.php" class="active">English </a>
               ...
               <li class="phone-fix-1">
                ...
                <ul class="mn-sub">
                    ...
                    <li><a href="../who-we-are.php">English</a></li>
...
=======
            <?php include('nav.html'); ?>
>>>>>>> e9e776230c872c3f4b511233a5918bd0deff8e9a:sv/who-we-are.php
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-30">
                        <div class="mod-breadcrumbs font-alt align-right">
                            <a href="index.php">Startsida</a>&nbsp;/&nbsp;<span>Om oss</span>
                        </div>
        ...
        <!-- End Section -->
            ...
            <section class="page-section bg-dark" id="about">
                ...
                <!-- End About Section -->
                 ...
                 <!-- Head Section -->
            <section class="small-section bg-dark " id="padding-top" >
                <div class="relative container align-left">
